...
vid2 = File.open('https://s3.amazonaws.com/netflix-ds-seeds/daredevil.mp4')
photo2 = File.open('https://s3.amazonaws.com/netflix-ds-seeds/daredevil.jpg')
...
vid3 = File.open('https://s3.amazonaws.com/netflix-ds-seeds/avatar.mp4')
photo3 = File.open('https://s3.amazonaws.com/netflix-ds-seeds/avatar.jpg')
...
vid4 - File.open('https://s3.amazonaws.com/netflix-ds-seeds/arrow.mp4')
photo4 = File.open('https://s3.amazonaws.com/netflix-ds-seeds/arrow.png')
...
vid5 = File.open('https://s3.amazonaws.com/netflix-ds-seeds/flash.mp4')
photo5 = File.open('https://s3.amazonaws.com/netflix-ds-seeds/flash.jpg')
...
vid6 = File.open('https://s3.amazonaws.com/netflix-ds-seeds/theboys.mp4')
photo6 = File.open('https://s3.amazonaws.com/netflix-ds-seeds/theboys.jpg')
